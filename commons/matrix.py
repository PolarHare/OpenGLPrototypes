...
def frustrum_matrix_2d(left, right, near, far):
    '''
    :param left: left edge of frustrum (x axis) (on near line)
    :param right: right edge of frustrum (x axis) (on near line)
    ...
    :return: matrix, that transforms (x0, y0, w0) -> (x1, y1, w1),
        where x1 is in [-1.0, 1.0], if x0 is in frustrum perspective-cone,
...
if __name__ == '__main__':
    mat = frustrum_matrix_2d(-3, 5, 10, 100)
